...
export default function Scoreboard () {
  ...
  const { wrong, right, isLoggedIn, highScore, currentScore, level, totalScore } = useContext(GlobalContext);

  return (
    <div className="headerCont" key={wrong + "_" + right + "_" + currentScore}>
      <div className="scoreCont">
        <span className = "equalsSymbol">Total Score:</span>
        <span className = "currentScore">{totalScore}</span>
        <span className = "equalsSymbol">Level {level}:</span>
